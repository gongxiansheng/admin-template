...
export default {
    ...
    computed: {
        ...
        calcLabelPosition() {
            return this.column.labelPosition || this.labelPosition || 'right'
        },
        labelStyle() {
            return {
...
.sst-form-item {
  ...
  &.is-label-left {
    ...
    ::v-deep .el-form-item__label {
      flex: 0 0 auto;
      .sst-form-item__label-wrap.is-required::before {
        content: "*";
        color: #f56c6c;
        margin-right: 4px;
      }
    ...
    ::v-deep .el-form-item__content {
      ...
      flex: 1;
      // overflow: hidden; // 导致系统管理 新增成员 密码验证错误信息 没有显示问题
    }
  }
  &.is-label-right ::v-deep > .el-form-item__label {
    text-align: right !important;
  }
  &-is-label-left ::v-deep > .el-form-item__label {
