...
<script>
import SstRender from './Render'
// import forced from './forced.js';
export default {
    name: 'SstColumn',

    components: { SstRender },
    inheritAttrs: false,
    props: {
        column: {
            type: Object,
    ...
    computed: {
        calcAlignForCols() {
            return this.column.align || this.colAlign || this.$sstTable.colAlign || 'center'
        },
        calcHeaderAlignForCols() {
            return this.column.headerAlign || this.colHeaderAlign || this.$sstTable.colHeaderAlign || this.calcAlignForCols
        },
        calcEmptyTextForCols() {
            return this.colEmptyText || this.$sstTable.colEmptyText
        },
        calcShowOverflowTooltip() {
            return this.column.showOverflowTooltip || this.colShowOverflowTooltip || this.$sstTable.colShowOverflowTooltip
        }
    },
    watch: {
        column: {
